use super::fake_gh::{OPEN_SCRIPT, executable, gh_script};
use super::*;
...
impl GitHubFixture {
    ...
    pub(super) fn command(&self, args: &[&str]) -> Result<ProcessCommand> {
    ...
    pub(super) fn read(&self, args: &[&str]) -> Result<Run> {
    ...
    pub(super) fn gh_calls(&self) -> Result<String> {
