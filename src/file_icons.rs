...
extension_catalog!(
    ...
    SOLIDITY => ["sol"],
    GRAPHQL => ["graphql", "gql"],
    BINARY => ["wasm", "exe", "dll", "so", "dylib", "a", "lib", "elf", "bin", "appimage", "bc", "pkl", "pickle", "joblib", "npy", "npz", "pt", "pth", "onnx", "tflite", "safetensors", "glb", "fbx", "blend", "usdz", "mo", "shp", "shx", "pcap", "pcapng", "graffle", "pyc", "splinecode"],
    BASH => ["sh", "bash"],
    SHELL => ["zsh", "fish", "nu", "bat", "cmd", "awk", "command", "ksh"],
    POWERSHELL => ["ps1", "psm1", "psd1"],
    DATABASE => ["sql", "db", "sqlite", "sqlite3", "mdb", "prisma", "edgeql", "psql", "dbf", "mmdb", "realm", "testdb"],
    JSON => ["json", "jsonc", "json5", "jsonl", "ndjson", "webmanifest", "geojson", "topojson"],
    XML => ["xml", "xsd", "xsl", "xslt", "dtd", "manifest"],
    ...
    YAML => ["yaml", "yml"],
    CONFIG => ["toml", "ini", "cfg", "conf", "config", "properties", "bazel", "bzl", "bzlmod", "cmake", "cue", "dhall", "ron", "rego", "makefile", "babelrc", "browserslistrc", "coveragerc", "editorconfig", "eslintrc", "flake8", "flowconfig", "graphqlconfig", "prettierrc", "swcrc", "cnf", "code-workspace", "code-snippets", "tmlanguage", "desktop", "service", "socket", "timer", "gyp", "reg", "reg2", "dist", "acl", "lldb", "supp", "winget"],
    TERRAFORM => ["hcl", "tf", "tfvars"],
    NIXOS => ["nix"],
    LOCK => ["lock", "resolved", "sum", "lockb", "bin-linking", "default", "v2", "v2-most-features"],
    MARKDOWN => ["md", "markdown", "mdown", "mkdn", "mdx", "rst", "adoc", "asciidoc", "org", "mdc", "pod", "roff", "man", "1", "2", "3", "4", "5", "6", "7", "8", "9"],
    TEXT => ["txt", "po", "pot", "arb", "xlf", "xliff", "xmb", "xtb", "ics", "eml", "cff", "text", "log", "stdout", "stderr", "http", "http2", "attr", "custom", "ext", "file", "invalid-rules-of-hooks-f6f37b63b2d4", "patterns", "samples", "status", "test", "unknown", "weird", "world"],
    ...
    IMAGE => ["svg", "png", "jpg", "jpeg", "gif", "webp", "avif", "bmp", "ico", "tif", "tiff", "psd", "ai", "sketch", "apng", "heic", "icns", "exr", "hdr", "tga", "dds", "cur", "jp2", "jxl", "ktx", "ktx2", "pbm", "pgm", "ppm", "pnm", "xpm", "xcf", "qoi", "pic", "dng", "cr2", "nef", "jfif"],
    AUDIO => ["mp3", "wav", "flac", "ogg", "m4a", "aac", "aiff", "opus", "pcm", "mid", "midi", "m3u", "m3u8", "pls"],
    VIDEO => ["mp4", "mkv", "mov", "avi", "webm", "m4v", "vtt", "srt", "ass"],
    ARCHIVE => ["zip", "tar", "gz", "bz2", "xz", "7z", "rar", "zst", "tgz", "tbz2", "txz", "asar", "br", "lzma", "nupkg", "whl", "egg", "ipa", "pkg", "dmg", "kmz", "bak", "old", "gzip", "z"],
    FONT => ["ttf", "otf", "woff", "woff2", "eot"],
    KEY => ["pem", "key", "pub", "keystore", "age", "asc", "gpg", "ppk", "sig", "env", "local", "exponent", "modulus", "sha1", "sha256"],
    CERTIFICATE => ["crt", "cer", "p12", "pfx", "cert", "csr", "der", "spdx", "spkac", "srl"],
    PACKAGE => ["deb", "rpm", "apk", "msi", "wixproj", "wxs", "wxi", "wxl", "iss", "nsi", "nsh"],
    DOCKER => ["dockerfile", "autobahn", "mariadb-plain", "mysql-native-password", "mysql-plain", "postgres-auth", "postgres-plain", "squid"],
    NPM => ["npmrc"],
    NODE => ["nvmrc", "node"],
    YARN => ["yarnrc"],
    GIT => ["orig", "patch", "diff"],
